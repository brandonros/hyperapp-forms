  ...
  function Fields (ref) {
    ...
    h( 'div', { class: "form-inline" },
      fields.map(function (ref, index) {
          ...
          return (h( Field, { id: id, type: type, title: title, value: model[id], options: options, render: type === 'static' ? undefined : function () { return render({id: id, key: key}); }, disabled: disabled, style: style, onChange: type === 'static' ? undefined : function () { return onChange({id: id, key: key}); } }))
        })
    )
  ); };
  }
      ...
      model.map(function (row, index) { return (
          h( 'div', null,
            fields.map(function (ref) {
                ...
                return h( Field, { id: id, type: type, title: title, value: row[id], render: function () { return render({id: id, index: index, key: key}); }, options: options, disabled: disabled, style: style, onChange: function () { return onChange({id: id, index: index, key: key}); } })
              }),
